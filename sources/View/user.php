                        ...
                        <div class="order-box__dashboard">
                            <?
                                ...
                                foreach($orders as $order) {
                                    $ods = $orderDetailDAO->getAllOrderDetailPayedByUserIdAndOrderID($user->getID(), $order->getID());
                            ?>
                            <section class="order-detail-box">
                                ...
                                <article class="order-detail-box__body">
                                    <? foreach ($ods as $od) { 
                                        $pd = $productDAO->getProductByID($od->getProductID());    
                                    ?>
                                    <article class="order">
                                        <div class="order-thumbnail">
                                            <img src="<? echo $pd->getImg(); ?>" alt="">
                                            <p class="quantity">
                                                <? echo $od->getQuantity(); ?>
                                            </p>
                                        </div>
                                ...
                                <article class="order-detail-box__foot">
                                    <div class="price">
                                        <span>Tổng tiền:</span> <? echo $order->getPrice(); ?>
                                    </div>
                                    <a href="#" class="detail">
                                        Xem chi tiết
                                    </a>
